...
function BibtexDisplay() {
  ...
  this.displayBibtex = function(output) {
    // parse bibtex input
    var b = new BibtexParser();
    b.setInput(output.html());
    b.bibtex();
    ...
    for (var entryKey in entries) {
      ...
      // find template
      var tpl = $(".bibtex_template").clone().removeClass('bibtex_template').children(0);
      //var tpl = $(".bibtex_template").html();
      ...
      tpl.find("a.google").attr("href", 'http://www.google.com/search?q=%7B'+entry['TITLE']+'%7D');
      tpl.find("a.scholar").attr("href", 'http://scholar.google.com/scholar?q=%7B'+entry['TITLE']+'%7D');
